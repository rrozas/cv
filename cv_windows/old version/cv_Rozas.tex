...
\header{Rony}{Rozas}{Ingénieur en R\&D} % Your name and current job title/field
...
~
\section{Références}
Patrice Aknin - {\small \itshape SNCF}
Directeur scientifique  
+33 (0)1 57 23 62 92 
~
Laurent Bouillaut - {\small \itshape IFSTTAR}
Chargé de recherche
+33 (0)1 81 66 87 16 
~
Nihal Pekergin - {\small \itshape UPEC}
Enseignant / chercheur
+33 (0)1 45 17 16 44\vspace{\parsep}
\end{aside}
...
\entryinline
{Méthodes}
{Optimisation : Combinatoire, Multicritère, Métaheuristique, Programmation dynamique, Programmation par contraintes, Programmation linéaire  \\
Processus stochastiques : R\'{e}seaux Bay\'{e}siens, Cha\^{i}ne de Markov \\
...
\entryinline
{Langages}
{Java, C++, C, Python, W-langage (Windev/Webdev)}
%%------------------------------------------------
%\entryinline
%{Graphisme}
...
\begin{entrylist}
\entryinline{Loisirs}{Volley-ball, roller, salsa}
