...
\entryinline
{Méthodes}
{Optimisation : Combinatoire, Multicritère, Métaheuristique, Programmation dynamique, Programmation par contraintes  \\
...
\entryinline
{Langages}
{Java, C++, C, Python, Javascript, PHP, HTML, W-langage (Windev/Webdev)}
%%------------------------------------------------
%\entryinline
%{Graphisme}
