...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[a4paper]{friggeri-cv-white-mac} % Add 'print' as an option into the square bracket to remove colors from this template for printing
